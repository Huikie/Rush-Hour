...
['#', '#', '#', '#', '#', '#', '#', '#']
    ...
    def move(self, car, moves):
        ...
        if self.cars.cars[car][0][0] == self.cars.cars[car][1][0] and moves > 0:
            # moves cars to the right
                # checks if move is valid
            for i in range(1, moves + 1):
                return validMoveHorizontal(self, car, moves, i, lijst)
        ...
        # Move cars that are positioned vertically
            ...
            if moves > 0:
                # checks if move is valid
                for i in range(1, moves + 1):
                    return validMoveVertical(self, car, moves, i, lijst)
...
def validMoveHorizontal(self, car, moves, i, lijst):
...
def validMoveVertical(self, car, moves, i, lijst):
    for cordinate in self.cars.cars[car]:
